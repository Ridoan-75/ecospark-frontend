...
import {
  Mail, Sparkles, ArrowRight, Shield, Zap, Users, Leaf, Globe, Lightbulb, CheckCircle2,
} from "lucide-react";
        ...
        <div className="glass gradient-border rounded-3xl p-10 md:p-14 lg:p-16">
          ...
          <div className="text-center max-w-2xl mx-auto mb-14">
            <div className="inline-flex items-center gap-2 glass-purple rounded-full px-5 py-2 border border-purple-400/20 mb-6">
              ...
              <span className="text-purple-300 text-sm font-medium">Stay Updated</span>
            </div>
            ...
            <p className="text-white/50 text-lg">
              Get exclusive updates, sustainability ideas, and top voted projects directly to your inbox.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              ...
              <p className="text-white/60 leading-relaxed text-lg">
                Stay ahead with curated content designed to help you discover impactful ideas and stay connected with the community.
              </p>

              <div className="flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4 text-purple-400" />
                  <span className="text-white/60 text-sm">2,400+ subscribers</span>
                </div>
                <div className="w-px h-4 bg-white/10" />
                <div className="flex items-center gap-2">
                  <Zap className="w-4 h-4 text-purple-400" />
                  <span className="text-white/60 text-sm">Weekly updates</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                {["Top voted projects", "Sustainability tips", "Early announcements"].map((tag) => (
                  <span
                    key={tag}
              ...
              {!isSubscribed ? (
                ...
                <div className="glass-purple border border-purple-400/20 rounded-2xl p-6 flex flex-col items-center justify-center text-center space-y-3">
