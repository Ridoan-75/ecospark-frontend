import { Lightbulb, Send, ThumbsUp, Sparkles } from "lucide-react";
    ...
    <section className="py-24 px-4 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connector line */}
          <div className="hidden md:block absolute top-16 left-1/3 right-1/3 h-px bg-gradient-to-r from-transparent via-purple-500/30 to-transparent" />
